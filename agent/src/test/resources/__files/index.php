...
<body class="default-dark hold-transition sidebar-mini layout-boxed logged-in">
<noscript>
    <!-- JS Warning -->
    <div>
...
<div id="token" hidden>onkCTORwQg9dTCb1TIcODruG0omfaGPiShVuLpxmH24=</div>
<!-- Send token to JS -->
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    ...
                    <span title="Detected 1 cores"><i class="fa fa-w fa-circle text-green-light"></i> Load:&nbsp;&nbsp;0.04&nbsp;&nbsp;0.1&nbsp;&nbsp;0.09</span>                    <br/>
                    <span><i class="fa fa-w fa-circle text-green-light"></i> Memory usage:&nbsp;&nbsp;28.8&thinsp;%</span>                    <br/>
                    <span id="temperature"><i class="fa fa-w fa-fire text-vivid-blue" style="width: 1em !important"></i> Temp:&nbsp;<span id="rawtemp" hidden>37.394</span><span id="tempunit" hidden></span><span id="tempdisplay"></span></span>                </div>
            </div>
...
<div class="row">
    ...
    <div class="col-lg-3 col-sm-6">
        <!-- small box -->
        <div class="small-box bg-green no-user-select" title="Adlists updated 5 days, 18:04 (hh:mm) ago">
            <div class="inner">
...
<script src="scripts/pi-hole/js/index.js?v=1707860387"></script>
        ...
        <div class="row row-centered text-center version-info">
            <div class="col-xs-12 col-sm-12 col-md-10">
                <ul class="list-inline">
                        ...
                        <a href="https://github.com/pi-hole/pi-hole/releases/v5.17.3" rel="noopener" target="_blank">v5.17.3</a>                                            </li>
                    <li>
                        <strong>FTL</strong>
                        <a href="https://github.com/pi-hole/FTL/releases/v5.25.1" rel="noopener" target="_blank">v5.25.1</a>                                            </li>
                    <li>
                        <strong>Web Interface</strong>
                        <a href="https://github.com/pi-hole/AdminLTE/releases/v5.21" rel="noopener" target="_blank">v5.21</a>                                            </li>
                </ul>
...
<!-- ./wrapper -->
<script src="scripts/pi-hole/js/footer.js?v=1707860387"></script>
</body>
</html>
